...
<div data-type="exercise" class="exercise">
<div data-type="problem" class="problem" markdown="1">
Use the data in [Appendix I](/The Nearest Stars){: .target-chapter} to plot an H–R diagram for this sample of nearby stars. How does this plot differ from the one for the brightest stars in [[link]](#fs-id1164754897807)? Why?
