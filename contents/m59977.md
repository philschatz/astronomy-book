...
—From the poem “Fire and Ice” by Robert Frost (1923)</q>
...
* {: data-type="footnote-ref" #footnote1} [1](#footnote-ref1){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">By equivalent mass we mean that which would result if the energy were turned into mass using Einstein’s formula, *E* = *mc*<sup>2</sup>.</span>
