...
Cepheids are large, yellow, pulsating stars named for the first-known star of the group, **Delta Cephei**{: data-type="term" .no-emphasis}. This, by the way, is another example of how confusing naming conventions get in astronomy; here, a whole class of stars in named after the constellation in which the first one happened to be found. (We textbook authors can only apologize to our students for the whole mess!)
