...
1.  [1](#footnote-ref1){: data-type="footnote-ref" name="footnote1"} Generally we use standard metric (or SI) units in this book. The proper metric unit of density in that system is kg/m<sup>3</sup>. But to most people,
    * * *
    {: data-type="newline"}
    
    g/cm<sup>3</sup> provides a more meaningful unit because the density of water is exactly 1 g/cm<sup>3</sup>, and this is useful information for comparison. Density expressed in g/cm<sup>3</sup> is sometimes called specific density or specific weight.
